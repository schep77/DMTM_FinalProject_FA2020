...
totalBirths2006 <- Births2006 %>% 
  mutate(Births2006, total_births = (births/4335154) * 1000)
totalBirths2006
>>>>>>> 65948cea96f0e3bf2007c08c42b62d7c1d73afd5
```
...
afterRecession2010 <- afterRecession %>% 
  mutate(afterRecession, total_births = (births/4055975) * 1000)
afterRecession2010
```
...
Note 2: Fixed the blocks with errors.




## Anomly Dectection with Birthrates - Kyle 



## Days of the week - Orel 
